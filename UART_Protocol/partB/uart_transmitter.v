module uart_transmitter(
    ...
    always @(posedge clk or posedge reset) begin
        if (reset) begin
            ...
            Tx_WR_d <= Tx_WR_debounced;
        end
    end
    wire Tx_WR_rising = (Tx_WR_debounced && !Tx_WR_d); //if Tx_WR_debounced = 1 and Tx_WR_d = 0 ---> Tx_WR_rising = posedge(Tx_WR)
    ...
    always @(current_state or Tx_WR_rising or Tx_EN_sync or Tx_sample_ENABLE
             or bit_index or sample_count or tx_symbol or Tx_DATA) begin
