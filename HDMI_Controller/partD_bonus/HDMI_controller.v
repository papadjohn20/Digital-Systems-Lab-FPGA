module HDMI_controller(
    ...
    input  wire [7:0] sw,   // board switches
    ...
    //----------------------------------------------------
    // wire [7:0] red   = sw & {8{rgb[2]}};
    // wire [7:0] green = sw & {8{rgb[1]}};
    // wire [7:0] blue  = sw & {8{rgb[0]}};

     wire [7:0] red   = (rgb[2]) ? (sw): 8'b0;
     wire [7:0] green = (rgb[1]) ? (sw): 8'b0;
     wire [7:0] blue  = (rgb[0]) ? (sw): 8'b0;

//    wire [7:0] red   = {2{rgb[2]}};
//    wire [7:0] green = {2{rgb[1]}};
//    wire [7:0] blue  = {2{rgb[0]}};
